...
<html>
  ...
  <style type="text/css">
    ...
    <p align="center" ><b><font size="8">核准租借訂單</font></b></p>
    <table border="3" align="center" class = "table table-striped" bordercolor="rhba(255,255,255,0)">
		<?php
            # get receipt serial
            $sql = "SELECT receipt_serial FROM receipt WHERE accept=0 GROUP BY receipt_serial ORDER BY receipt_serial ASC";
            ...
            if(COUNT($serial) == 0) {
                ...
                foreach ($serial as $key) {
                    ...
                    $print .= '</font>
                          ...
                          <td width="60%" colspan="1" align="center"><label>
                          <font size="3" color="#000000">';
                    ...
                    echo '<form name="dataForm" method="post" action="DB_accept_action.php" >
