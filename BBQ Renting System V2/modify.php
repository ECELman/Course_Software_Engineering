<?php
  ...
  if ($passed != "TRUE")
  {
    header("location:DB_select_person.php");
    exit();
  }
  ...
  else
  {
    ...
    $sql = "SELECT * FROM rent_person,user Where rent_person.id = '$id' AND user.id = '$id'";
...
<html>
  ...
  <body cellpadding="100">
    ...
    <form  class="form-inline" name="dataForm" method="post" action="update.php" >
          ...
          <td colspan="2" align="CENTER"> 
			<div class="form-group">
				<div class="col-sm-offset-0 col-sm-20">
					...
					<button type="button" class="btn btn-default" onClick='location.href="main.php"'>取消修改</button>
				</div>
			</div>
          </td>
        </tr>
